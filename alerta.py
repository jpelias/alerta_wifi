...
observedclients = ["00:ff:00:10:c6:00","7c:ff:93:10:ff:ff","40:ff:08:ff:7e:ff","40:6a:ab:ff:ff:ff","24:E2:71:ff:ff:ff"]

nameclients = ["C","D","R","Z","M"]
...
def sniffmgmt(p):
    ...
    if p.haslayer(Dot11):
        ...
        if p.type == 0 and p.subtype in stamgmtstypes:
            ...
            # it to our list.
	    if p.addr2 in observedclients:
                
                indicecliente = observedclients.index(p.addr2)
                if indicecliente == 4 : os.system("/usr/bin/mplayer clockchimes.ogg &")
                # print nameclients[indicecliente],indicecliente
            else:
                print p.addr2
